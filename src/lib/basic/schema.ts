...
import {
  defaultBlockMathParseRules, defaultInlineMathParseRules
...
export const schema = new Schema({
  nodes: {
    ...
    math_inline: {
      ...
      parseDOM: [{ tag: "math-inline" }, defaultInlineMathParseRules[0]]
    },
    ...
    math_display: {
      ...
      parseDOM: [{ tag: "math-display" }, defaultBlockMathParseRules[0]]
    }
  },
